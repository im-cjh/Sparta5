...
export const file_game: GenFile = /*@__PURE__*/
  fileDesc("CgpnYW1lLnByb3RvEghQcm90b2NvbCJbChFDMkJfSW5pdGlhbFBhY2tldBIkCgRtZXRhGAEgASgLMhYuUHJvdG9jb2wuQzJTX01ldGFkYXRhEg4KBnJvb21JZBgCIAEoDRIQCghuaWNrbmFtZRgDIAEoCSJACg1CMkNfRW50ZXJSb29tEiQKBG1ldGEYASABKAsyFi5Qcm90b2NvbC5TMkNfTWV0YWRhdGESCQoBcxgCIAEoCWIGcHJvdG8z", [file_client, file_server, file_struct]);
...
export type B2C_EnterRoom = Message<"Protocol.B2C_EnterRoom"> & {
  ...
  /**
   * @generated from field: string s = 2;
   */
  s: string;
};
